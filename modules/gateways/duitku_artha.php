 ...
 * @return array
 */
function duitku_artha_MetaData()
{
    return array(
        'DisplayName' => 'Duitku Artha Graha Payment Gateway',
 ...
 * @return string
 */
function duitku_artha_link($params)
{	
	//set session Order
	...
	$paymentMethod = "AG"; // PaymentMethod For Duitku
