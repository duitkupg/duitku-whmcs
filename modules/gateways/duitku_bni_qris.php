 ...
 * @return array
 */
function duitku_bni_qris_MetaData()
{
    return array(
        'DisplayName' => 'Duitku QRIS by BNI',
 ...
 * @return array
 */
function duitku_bni_qris_config()
{
    return array(
 ...
 * @return string
 */
function duitku_bni_qris_link($params)
{
	...
	$paymentMethod = "IQ"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_bni_qris/logo.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="BNI"><br>';
