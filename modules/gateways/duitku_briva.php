 ...
 * @return array
 */
function duitku_briva_MetaData()
{
    return array(
        'DisplayName' => 'Duitku BRIVA Payment Gateway Module',
 ...
 * @return string
 */
function duitku_briva_link($params)
{	
	//set session Order
	...
	$paymentMethod = "BR"; // PaymentMethod For Duitku
