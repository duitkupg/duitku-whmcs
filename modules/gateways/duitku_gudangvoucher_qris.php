 ...
 * @return array
 */
function duitku_gudangvoucher_qris_MetaData()
{
    return array(
        'DisplayName' => 'Duitku Gudang Voucher QRIS Payment Gateway Module',
 ...
 * @return array
 */
function duitku_gudangvoucher_qris_config()
{
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => 'Duitku Gudang Voucher QRIS',
        ),
 ...
 * @return string
 */
function duitku_gudangvoucher_qris_link($params)
{
	...
	$paymentMethod = "GQ"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_gudangvoucher_qris/logo.png"; 
