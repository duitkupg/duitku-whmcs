 ...
 * @return array
 */
function duitku_indomaret_MetaData()
{
    return array(
        'DisplayName' => 'Duitku Indomaret Payment Gateway Module',
 ...
 * @return array
 */
function duitku_indomaret_config()
{
    return array(
 ...
 * @return string
 */
function duitku_indomaret_link($params)
{	
	//set session Order
	...
	$paymentMethod = "IR"; // PaymentMethod For Duitku
