 ...
 * @return array
 */
function duitku_jenius_pay_MetaData()
{
    return array(
        'DisplayName' => 'Duitku Jenius Pay Payment Gateway Module',
 ...
 * @return array
 */
function duitku_jenius_pay_config()
{
    return array(
 ...
 * @return string
 */
function duitku_jenius_pay_link($params)
{
	...
	$paymentMethod = "JP"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_jenius_pay/logo.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="Jenius Pay"><br>';
