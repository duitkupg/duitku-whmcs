 ...
 * @return array
 */
function duitku_linkaja_qris_MetaData()
{
    return array(
        'DisplayName' => 'Duitku LinkAja QRIS Payment Gateway Module',
 ...
 * @return array
 */
function duitku_linkaja_qris_config()
{
    return array(
 ...
 * @return string
 */
function duitku_linkaja_qris_link($params)
{
	...
	$img       = $systemUrl . "/modules/gateways/duitku_linkaja_qris/logo.png"; 
