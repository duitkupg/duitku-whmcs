 ...
 * @return array
 */
function duitku_nusapay_qris_MetaData()
{
    return array(
        'DisplayName' => 'Duitku QRIS by NusaPay',
 ...
 * @return array
 */
function duitku_nusapay_qris_config()
{
    return array(
 ...
 * @return string
 */
function duitku_nusapay_qris_link($params)
{
	...
	$paymentMethod = "SQ"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_nusapay_qris/logo.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="NUSAPAY"><br>';
