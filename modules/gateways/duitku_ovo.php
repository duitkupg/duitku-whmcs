 ...
 * @return array
 */
function duitku_ovo_MetaData()
{
    return array(
        'DisplayName' => 'Duitku OVO Payment Gateway Module',
 ...
 * @return string
 */
function duitku_ovo_link($params)
{
	...
	$paymentMethod = "OV"; // PaymentMethod For Duitku
