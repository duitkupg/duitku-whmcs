...
{
    return array(
        'DisplayName' => 'Duitku QRIS by ShopeePay',
...
function duitku_shopee_config()
{
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => 'Duitku QRIS by ShopeePay',
        ),
...
function duitku_shopee_link($params)
{
	...
	$paymentMethod = "SP"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_shopee/logo.png"; 
