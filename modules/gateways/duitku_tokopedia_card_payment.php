 ...
 * @return array
 */
function duitku_tokopedia_card_payment_MetaData()
{
    return array(
        'DisplayName' => 'Duitku Tokopedia Card Payment Payment Gateway Module',
 ...
 * @return array
 */
function duitku_tokopedia_card_payment_config()
{
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => 'Duitku Tokopedia Card Payment',
        ),
 ...
 * @return string
 */
function duitku_tokopedia_card_payment_link($params)
{
	...
	$paymentMethod = "T1"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_tokopedia_card_payment/logo.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="Tokopedia Card Payment"><br>';
