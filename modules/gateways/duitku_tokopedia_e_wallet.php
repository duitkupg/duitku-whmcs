 ...
 * @return array
 */
function duitku_tokopedia_e_wallet_MetaData()
{
    return array(
        'DisplayName' => 'Duitku Tokopedia E-Wallet Payment Gateway Module',
 ...
 * @return array
 */
function duitku_tokopedia_e_wallet_config()
{
    return array(
        ...
        'FriendlyName' => array(
            'Type' => 'System',
            'Value' => 'Duitku Tokopedia E-Wallet',
        ),
 ...
 * @return string
 */
function duitku_tokopedia_e_wallet_link($params)
{
	...
	$paymentMethod = "T2"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_tokopedia_e_wallet/logo.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="Tokopedia E-Wallet"><br>';
