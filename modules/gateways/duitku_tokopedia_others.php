 ...
 * @return array
 */
function duitku_tokopedia_others_MetaData()
{
    return array(
        'DisplayName' => 'Duitku Tokopedia Others Payment Gateway Module',
 ...
 * @return array
 */
function duitku_tokopedia_others_config()
{
    return array(
 ...
 * @return string
 */
function duitku_tokopedia_others_link($params)
{
	...
	$paymentMethod = "T3"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_tokopedia_others/logo.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="Tokopedia Others"><br>';
