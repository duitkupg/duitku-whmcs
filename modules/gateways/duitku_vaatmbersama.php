 ...
 * @return array
 */
function duitku_vaatmbersama_MetaData()
{
    return array(
        'DisplayName' => 'Duitku VA ATM Bersama Payment Gateway Module',
 ...
 * @return array
 */
function duitku_vaatmbersama_config()
{
    return array(
 ...
 * @return string
 */
function duitku_vaatmbersama_link($params)
{
	...
	$paymentMethod = "A1"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku-images/duitku_vaatmbersama.png"; 
