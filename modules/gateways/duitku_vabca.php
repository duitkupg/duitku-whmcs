 ...
 * @return array
 */
function duitku_vabca_MetaData()
{
    return array(
        'DisplayName' => 'Duitku VA BCA Payment Gateway Module',
 ...
 * @return string
 */
function duitku_vabca_link($params)
{
	...
	$paymentMethod = "BC"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku-images/duitku_vabca.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="VA BCA"><br>';
