 ...
 * @return array
 */
function duitku_vabni_MetaData()
{
    return array(
        'DisplayName' => 'Duitku VA BNI Payment Gateway Module',
 ...
 * @return string
 */
function duitku_vabni_link($params)
{
	...
	$paymentMethod = "I1"; // PaymentMethod For Duitku
