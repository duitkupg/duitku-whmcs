 ...
 * @return array
 */
function duitku_vabsi_MetaData()
{
    return array(
        'DisplayName' => 'Duitku VA BSI Payment Gateway Module',
 ...
 * @return string
 */
function duitku_vabsi_link($params)
{
	...
	$paymentMethod = "BV"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_vabsi/logo.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="VA BSI"><br>';
