 ...
 * @return array
 */
function duitku_vacimb_MetaData()
{
    return array(
        'DisplayName' => 'Duitku VA CIMB Payment Gateway Module',
 ...
 * @return string
 */
function duitku_vacimb_link($params)
{
