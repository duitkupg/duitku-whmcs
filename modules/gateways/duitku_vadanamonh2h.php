 ...
 * @return array
 */
function duitku_vadanamonh2h_MetaData()
{
    return array(
        'DisplayName' => 'Duitku VA Danamon Module',
 ...
 * @return array
 */
function duitku_vadanamonh2h_config()
{
    return array(
 ...
 * @return string
 */
function duitku_vadanamonh2h_link($params)
{
	...
	$paymentMethod = "DM"; // PaymentMethod For Duitku
	...
	$img       = $systemUrl . "/modules/gateways/duitku_vadanamonh2h/logo.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="VA DANAMON"><br>';
