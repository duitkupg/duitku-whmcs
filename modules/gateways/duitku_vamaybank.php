 ...
 * @return array
 */
function duitku_vamaybank_MetaData()
{
    return array(
        'DisplayName' => 'Duitku VA Maybank Payment Gateway Module',
 ...
 * @return array
 */
function duitku_vamaybank_config()
{
    return array(
 ...
 * @return string
 */
function duitku_vamaybank_link($params)
{
	...
	$paymentMethod = "VA"; // PaymentMethod For Duitku
