 ...
 * @return array
 */
function duitku_varitel_MetaData()
{
    return array(
        'DisplayName' => 'Duitku Retail Payment Gateway Module',
 ...
 * @return array
 */
function duitku_varitel_config()
{
    return array(
 ...
 * @return string
 */
function duitku_varitel_link($params)
{	
	//set session Order
	...
	$paymentMethod = "FT"; // PaymentMethod For Duitku
	...
	$img       	= $systemUrl . "/modules/gateways/duitku-images/duitku_varitel.png"; 
    $htmlOutput .= '<img style="width: 152px;" src="' . $img . '" alt="Duitku Ritel"><br>';
